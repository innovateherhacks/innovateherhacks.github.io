...
export default function FAQs() {
    ...
    const faqs = [
        ...
        {question: "How are teams found? How many members can I have on my team?", answer: "At the beginning of the hackathon, we'll host workshops where you can meet other participants, connect with familiar faces, and join team-forming activities to find people you'd like to work with. If you're unable to form a team beforehand, don't worry! There is always discord, to start chatting and find people you would want to be in a team with! Whether you're comming with a preformed team or starting fresh, there's plenty of opportunity to collaborate and meet new people! You can have 2 to 4 people in your team!"},
